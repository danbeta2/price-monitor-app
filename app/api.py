...
def get_monitor_prices(monitor_id):
    ...
    # Se il tuo prezzo è €100, accettiamo da €50 a €200 (0.5x a 2x)
    min_reasonable = your_price * 0.5 if your_price else 0.01
    max_reasonable = your_price * 2.0 if your_price else 100000
